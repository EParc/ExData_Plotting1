...
png('plot4.png')
par(mfrow=c(2,2))
plot(consumptionData$dayTime, consumptionData$Global_active_power, type = "l", ylab = "Global Active Power",xlab = "",xaxt = "n")
axis(side=1, at=c(1,2,3), labels=c("Thu","Fri","Sat"))

plot(consumptionData$dayTime, consumptionData$Voltage, type = "l", ylab = "Voltage",xlab = "datetime",xaxt = "n")
axis(side=1, at=c(1,2,3), labels=c("Thu","Fri","Sat"))
...
plot(consumptionData$dayTime, consumptionData$Global_reactive_power, type = "l", ylab = "Global_reactive_power",xlab = "datetime",xaxt = "n")
axis(side=1, at=c(1,2,3), labels=c("Thu","Fri","Sat"))
dev.off()